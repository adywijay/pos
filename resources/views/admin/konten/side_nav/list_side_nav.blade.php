        ...
        <ul class="collapsible">
            <li>
                ...
                <div class="collapsible-body">
                    <ul>
                        <li><a href=""><i class="material-icons">enhanced_encryption</i>Product</a></li>
                        <li><a href=""><i class="material-icons">assignment_ind</i>Cashier</a></li>
                        <li><a href=""><i class="material-icons">add_shopping_cart</i>Cart</a></li>
                    </ul>
                </div>
            </li>
        </ul>

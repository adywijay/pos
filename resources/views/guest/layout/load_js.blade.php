...
<script src="{{ asset('load_extern/js/plugins/sweetalert2/dist/sweetalert2.all.min.js') }}"></script>
<script src="{{ asset('load_extern/js/plugins/sweetalert2/dist/sweetalert2.min.js') }}"></script>
...
<script src="{{ asset('load_extern/js/plugins/jquery-validation/jquery.validate.min.js') }}"></script>
